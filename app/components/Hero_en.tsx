...
export default function Hero_en() {
  ...
  return (
    <section id="hero" className="relative min-h-[100dvh] mt-4 overflow-hidden flex items-center bg-[#1A2B1C]">
      {/* Background */}
      ...
      <div className="container mx-auto px-8 md:px-12 lg:px-20 xl:px-28 2xl:px-32 relative z-10 min-h-[100dvh] flex items-center py-16">
        <div className="grid lg:grid-cols-12 gap-12 xl:gap-20 items-center w-full">
          ...
          <motion.div
            ...
            className="mt-5 lg:col-span-7 flex flex-col gap-9 lg:gap-11 items-center lg:items-start text-center lg:text-left px-6 sm:px-10 md:px-14 lg:px-16 xl:px-20"
            >
            {/* Name */}
            <div className="space-y-1 w-full mt-3">
              <h1 className="leading-none var(--font-ubuntu) font-bold tracking-[-3px]">
                <span className="block text-[#F0EBD6] text-[3.6rem] md:text-[5rem] lg:text-[5.6rem] xl:text-[6.2rem]">
                  Maitreyee
                </span>
          ...
          >
            <div className="relative w-full max-w-[320px] xl:max-w-[380px]">
              ...
              <div className="relative aspect-[4/4.9] overflow-hidden rounded-3xl border border-[#D4A843]/20 shadow-2xl bg-[#1A2B1C]/30">
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#1A2B1C]/50" />
                                    ...
                                    {/* Buttons */}
{/* Buttons */}
<div className="flex flex-col sm:flex-row items-center justify-center gap-4  pt-10 px-4"
...
>
  <motion.a
    ...
    whileTap={{ scale: 0.97 }}
    className="group bg-[#D4A843] hover:bg-[#8B2E2E] text-[#1A2B1C] hover:text-[#F0EBD6] font-semibold text-sm rounded-2xl flex items-center justify-center gap-3 shadow-lg shadow-[#D4A843]/30 transition-all duration-300"
  ...
  <motion.a
    ...
    whileHover={{ scale: 1.03 }}
    whileTap={{ scale: 0.97 }}
    className="border-2 border-[#4A7C59]/60 hover:border-[#D4A843] text-[#F0EBD6] font-medium text-sm rounded-2xl backdrop-blur-md hover:bg-[#D4A843]/10 transition-all duration-300"
    style={{ padding: '10px 20px' }}
  >
    Get In Touch
  </motion.a>
      ...
      <motion.div
        ...
        className="hidden lg:flex absolute bottom-0 left-1/2 -translate-x-1/2 flex-col items-center text-[#F0EBD6]/40 mt-4"
          >
        <span className="mt-4 text-xs tracking-[3px] font-light ">SCROLL TO EXPLORE</span>
        <div className="w-px h-14 bg-gradient-to-b from-transparent via-[#D4A843]/50 to-transparent mt-8" />
      </motion.div>
