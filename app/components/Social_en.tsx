...
export default function Social_en() {
  ...
  return (
    <section id="social">
      ...
      <div className="social-intro">
        <p>
          Stay connected with me on social media and be part of the cultural movement.
          Together, we are carrying heritage into the future.
        </p>
      </div>
